...
$DATA ../../data/501.csv 
IGNORE=C ; Ignore records beginning with letter C
...
$ERROR 
  ...
  IF (IPRED.NE.0) THEN
    IWRES = (DV-IPRED)/(IPRED)     ; Compute IWRES for IPRED != 0
  ELSE 
    IWRES = 0                      ; Set IWRES = 0 for IPRED = 0
  ENDIF
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;;  Print out individual predicted results and diagnostics to file 504.tab
;;;
;;;  Various parameters and built in diagnostics may be printed.
;;;   - DV=DEPENDENT VARIABLE
;;;   - CIPRED=individual predicted function, f(eta_hat), at mode of posterior density
;;;   - CIRES=DV-F(ETA_HAT)
;;;   - CIWRES=conditional individual residual:  (DV-F(ETA_HAT)/SQRT(SIGMA(1,1)*F(ETA_HAT))
...
$TABLE ID TIME DV IPRED PRED WT AGE SEX CIPRED CIRES CIWRES RES CWRES CL V ETA1 ETA2 NPDE WRES IRES IWRES CWRESI 
